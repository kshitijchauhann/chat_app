...
import {
  ...
  Container, useBreakpointValue, Link
      ...
      <Container maxW="container.xl" centerContent py={4}>
        <VStack spacing={6} w="full" align="center">
          ...
          <Flex justify="center" align="center" flexDirection={{ base: "column", sm: "row" }} textAlign="center" mt={4}>
            <Text mr={{ base: 0, sm: 2 }} mb={{ base: 2, sm: 0 }} color="gray.400" fontSize={{ base: "sm", md: "md" }}>Already have an account?</Text>
            <Link color="yellow.500" _hover={{ color: 'yellow.400' }} fontSize={{ base: "sm", md: "md" }}>
              Log In
            </Link>
          </Flex>
        </VStack>
